...
namespace WebApi.Controllers
{
    ...
    public class ResourceController : ApiController
    {
        ...
        // Path
        /// <summary>
        ///  Get allowable subset of resources by Helpline   
        /// </summary>
        /// <param name="lang">language. English = "en"; French = "fr"</param>
        /// <param name="token">Access token</param>
        /// <returns>return a subset of resource Helpline list format in json</returns>
        [ActionName("json")]
        [Route("api/v3/resource/helpline/json/{token}/{lang}/{phone}")]
        [Route("api/v3/Ressource/dassistance/json/{token}/{lang}/{phone}")]
        [ResponseType(typeof(SubRamResource))]
        [HttpGet]
